...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="dentalCare" runat="server" 
        ...
        SelectCommand="SELECT * FROM [DentalCare] WHERE DentalData = @dentalData"></asp:SqlDataSource>
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewDentalCare" runat="server" 
            ...
            onitemdeleting="listviewDentalCare_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="DentalEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("DentalEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="DentalCareLabel" runat="server" Text='<%# Eval("DentalData") %>' />
                    </td>
                    <td>
        ...
        <%--            <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="DentalDataTextBox" runat="server" 
                            Text='<%# Bind("DentalData") %>' />
                    </td>
                    <td>
            ...
            <InsertItemTemplate>
                <tr style="">
                    ...
                    <td>
                        <asp:Label ID="PopulationTextBox" runat="server" Text="---------" />
                    </td>
                    <td>
                        <asp:TextBox ID="MaleTextBox" runat="server" Text='<%# Bind("Male") %>' />
                    </td>
                    ...
                    <td>
                        <asp:Label ID="TargetTextBox" runat="server" Text="---------" />
                    </td>
                </tr>
            </InsertItemTemplate>
            <ItemTemplate>
                <tr style="background-color: #E0FFFF;color: #333333;">
                    ...
                    <td>
                        <asp:Label ID="DentalDataLabel" runat="server" Text='<%# Eval("DentalData") %>' />
                    </td>
                    <td>
