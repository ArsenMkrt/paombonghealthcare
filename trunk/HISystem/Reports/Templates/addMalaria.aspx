<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.master" AutoEventWireup="true" CodeFile="addMalaria.aspx.cs" Inherits="Reports_Templates_addMalaria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewMalaria" runat="server" 
            InsertItemPosition="LastItem" 
            oniteminserting="listviewMalaria_ItemInserting" 
            onitemdeleting="listviewMalaria_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="MalariaEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("MalariaEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="MalariaDataLabel" runat="server" Text='<%# Eval("MalariaData") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="PregnantLabel" runat="server" Text='<%# Eval("Pregnant") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="MalariaDataTextBox" runat="server" 
                            Text='<%# Bind("MalariaData") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      <td>
                        <asp:TextBox ID="PregnantTextBox" runat="server" Text='<%# Bind("Pregnant") %>' />
                    </td>
                    <td>
