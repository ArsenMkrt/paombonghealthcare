...
public partial class Reports_Templates_xDentalCare : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //        data.InsertDentalCareReport(indicatorData, Int32.Parse(male), Int32.Parse(female), data.GetBarangayID(lbl_Barangay.Text),
        //            month, year);
        //    }
