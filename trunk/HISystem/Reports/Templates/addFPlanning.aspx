<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.master" AutoEventWireup="true" CodeFile="addFPlanning.aspx.cs" Inherits="Reports_Templates_addFPlanning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewFP" runat="server" 
            InsertItemPosition="LastItem" 
            oniteminserting="listviewFP_ItemInserting" 
            onitemdeleting="listviewFP_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="FPEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("FPEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="FPDataLabel" runat="server" Text='<%# Eval("FPData") %>' />
                    </td>
                    <td>
                         <asp:Label ID="Population1" runat="server" Text='<%# Eval("Population") %>' />
                    </td>
                    <td>
                        <asp:Label ID="StartUserLabel" runat="server" Text='<%# Eval("StartUser") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="DropOutLabel" runat="server" Text='<%# Eval("DropOut") %>' />
                    </td>
                     <td>
                        <asp:Label ID="EndUserLabel" runat="server" Text='<%# Eval("EndUser") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                    ...
                    <td>
                        <asp:TextBox ID="FPDataTextBox" runat="server" Text='<%# Eval("FPData") %>' />
                    </td>
                    <td>
                         <asp:TextBox ID="PopulationTextBox" runat="server" Text='<%# Eval("Population") %>' />
                    </td>
                    
                    <td>
                        <asp:TextBox ID="StartUserTextBox" runat="server" Text='<%# Eval("StartUser") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="NewTextBox" runat="server" Text='<%# Eval("New") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="OthersTextBox" runat="server" Text='<%# Eval("Others") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="DropOutTextBox" runat="server" Text='<%# Eval("DropOut") %>' />
                    </td>
                     <td>
                        <asp:TextBox ID="EndUserTextBox" runat="server" Text='<%# Eval("EndUser") %>' />
                    </td>
                    <td>
                        <asp:Label ID="InputDateLabel" runat="server" Text='<%# Eval("InputDate") %>' />
                    </td>
                    ...
                    <td>
                     ...
                     <td>
                        <asp:TextBox ID="Target1" runat="server" Text='<%# Eval("Target") %>' />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <InsertItemTemplate>
                <tr style="">
                    ...
                    <td>
                        <asp:TextBox ID="StartUserTextBox" runat="server" Text='<%# Bind("StartUser") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="NewTextBox" runat="server" Text='<%# Bind("New") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="OthersTextBox" runat="server" Text='<%# Bind("Others") %>' />
                    </td>
                     <td>
                        <asp:TextBox ID="DropOutTextBox" runat="server" Text='<%# Bind("DropOut") %>' />
                    </td>
                       <td>
