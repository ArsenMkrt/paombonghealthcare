<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate4.master" AutoEventWireup="true" CodeFile="ViewPatient.aspx.cs" Inherits="Patient_Demographics_ViewPatient" %>
    ...
    <br />
        ...
        style="height:93px;width: 129px; border:solid 2px #2c6402;" border="2">
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000000" 
                ...
                <td class="style3">
                    ...
                    <asp:DropDownList ID="ddlBarangay" runat="server" datasourceid="Barangay0" 
                        DataTextField="BarangayName" DataValueField="BarangayName" Enabled="False">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="style12" style="height: 52px" colspan="2">
                    <asp:Label ID="lbl_lname" runat="server" Font-Bold="False" Font-Italic="True" 
                        Font-Size="Large"></asp:Label>
                    <br />
                    Last name</td>
                <td class="style10" colspan="2" style="height: 52px">
                    <asp:Label ID="lbl_fname" runat="server" Font-Bold="False" Font-Italic="True" 
                        Font-Size="Large"></asp:Label>
                    <br />
                    First name</td>
                <td class="style13">
                    <asp:Label ID="lbl_mname" runat="server" Font-Bold="False" Font-Italic="True" 
                        Font-Size="Large"></asp:Label>
                    <br />
                    Middle name</td>
            ...
            <tr>
                ...
                <td class="style5" colspan="3" style="width: 179px">
                    <asp:TextBox ID="txtContactNum" runat="server" Width="203px" ReadOnly="True"></asp:TextBox>
                </td>
                <td class="style14">
        ...
        Text="PhilHealth #"></asp:Label>
            ...
            <tr>
                ...
                <td class="style12" colspan="3" style="width: 179px">
                    ...
                    <asp:RadioButton ID="radiobutton_Male" runat="server" Font-Bold="True" 
                        ForeColor="#000000" GroupName="genderList"  Text="Male" Enabled="False" />
                </td>
                <td class="style14">
                ...
                <td class="style6" colspan="2">
                    <asp:DropDownList ID="ddlCivilStatus" runat="server" Enabled="False">
            ...
            <tr>
                ...
                <td class="style5" colspan="3" style="width: 179px">
                    <asp:TextBox ID="txtEmailAdd" runat="server" Width="206px" ReadOnly="True"></asp:TextBox>
                </td>
                <td class="style14">
                ...
                <td class="style6" colspan="2">
                    <asp:TextBox ID="txtCity" runat="server" Width="227px" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" style="width: 161px">
                ...
                <td class="style6" colspan="2">
                    <asp:TextBox ID="txtBirthplace" runat="server" Width="227px" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style5" colspan="3" style="width: 179px">
                    <asp:TextBox ID="txtCompany" runat="server" Width="207px" ReadOnly="True"></asp:TextBox>
                </td>
                <td class="style14">
                ...
                <td class="style6" colspan="2">
                    <asp:TextBox ID="txtSpouseName" runat="server" Width="228px" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" style="width: 161px">
                ...
                <td class="style12" colspan="3" style="width: 179px">
                    <asp:TextBox ID="txtNationality" runat="server" Width="208px" ReadOnly="True"></asp:TextBox>
                </td>
                <td class="style14">
                ...
                <td class="style6" colspan="2">
                    <asp:TextBox ID="txtDoctor" runat="server" Width="227px" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" style="width: 161px">
