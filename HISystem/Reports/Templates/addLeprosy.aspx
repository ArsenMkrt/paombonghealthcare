<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.master" AutoEventWireup="true" CodeFile="addLeprosy.aspx.cs" Inherits="Reports_Templates_addLeprosy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DropDownList ID="ddlIndicator" runat="server" AutoPostBack="True" 
        ...
        style="top: 61px; left: 54px; position: absolute; height: 20px; width: 542px">
    </asp:DropDownList>
    <br />
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewLeprosy" runat="server" 
            InsertItemPosition="LastItem" 
            oniteminserting="listviewLeprosy_ItemInserting" 
            onitemdeleting="listviewLeprosy_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="LeprosyEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("LeprosyEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="LeprosyLabel" runat="server" Text='<%# Eval("LeprosyData") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="LeprosyDataTextBox" runat="server" 
                            Text='<%# Bind("LeprosyData") %>' />
                    </td>
                    <td>
