<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.master" AutoEventWireup="true" CodeFile="addTuberculosis.aspx.cs" Inherits="Reports_Templates_addTuberculosis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewTuberculosis" runat="server" 
            InsertItemPosition="LastItem" 
            oniteminserting="listviewTuberculosis_ItemInserting" 
            onitemdeleting="listviewTuberculosis_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="TBEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("TuberculosisEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="TuberculosisDataLabel" runat="server" Text='<%# Eval("TuberculosisData") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="TuberculosisDataTextBox" runat="server" 
                            Text='<%# Bind("TuberculosisData") %>' />
                    </td>
                    <td>
