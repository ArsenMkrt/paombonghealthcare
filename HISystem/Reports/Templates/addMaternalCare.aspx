<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.master" AutoEventWireup="true" CodeFile="addMaternalCare.aspx.cs" Inherits="Reports_Templates_addMaternalCare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewMaternalCare" runat="server" 
            InsertItemPosition="LastItem" 
            oniteminserting="listviewMaternalCare_ItemInserting" 
            onitemdeleting="listviewMaternalCare_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="MaternalEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("MaternalEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="MaternalCareLabel" runat="server" Text='<%# Eval("MaternalData") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblNumberPatients" runat="server" Text='<%# Eval("NumberOfPatients") %>' />
                    </td>
 <%--                   <td>
        ...
        <%--            <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="MaternalCareDataTextBox" runat="server" 
                            Text='<%# Bind("MaternalData") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="PopulationTextBox" runat="server" Text='<%# Bind("Population") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="lblNumberOfPatients" runat="server" Text='<%# Bind("NumberOfPatients") %>' />
                    </td>
             <%--       <td>
            ...
            <InsertItemTemplate>
                <tr style="">
                    ...
                    <td>
                        <asp:TextBox ID="txtNumberOfPatients" runat="server" Text='<%# Bind("NumberOfPatients") %>' />
                    </td>
            <%--        <td>
                        <asp:TextBox ID="FemaleTextBox" runat="server" Text='<%# Bind("Female") %>' />
                    </td>--%>
            ...
            <ItemTemplate>
                <tr style="background-color: #E0FFFF;color: #333333;">
                    ...
                    <td>
                        <asp:Label ID="MaternalDataLabel" runat="server" Text='<%# Eval("MaternalData") %>' />
                    </td>
                    <td>
                        <asp:Label ID="PopulationLabel" runat="server" Text='<%# Eval("Population") %>' />
                    </td>
                    <td>
                        <asp:Label ID="lblNumberOfPatients" runat="server" Text='<%# Eval("NumberOfPatients") %>' />
                    </td>
              <%--      <td>
                        <asp:Label ID="FemaleLabel" runat="server" Text='<%# Eval("Female") %>' />
                    </td>--%>
            ...
            <SelectedItemTemplate>
                <tr style="background-color: #E2DED6;font-weight: bold;color: #333333;">
                  <%--  <td>
                    ...
                    <td>
                        <asp:Label ID="LeprosyDataLabel" runat="server" Text='<%# Eval("LeprosyData") %>' />
                    </td>
                    <td>
                        <asp:Label ID="PopulationLabel" runat="server" Text='<%# Eval("Population") %>' />
                    </td>
