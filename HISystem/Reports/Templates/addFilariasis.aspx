...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Panel ID="pnl_listview" runat="server" ScrollBars="Both" 
        ...
        <asp:ListView ID="listviewFilariasis" runat="server" 
            ...
            onitemdeleting="listviewFilariasis_ItemDeleting">
            <AlternatingItemTemplate>
                <tr style="background-color: #FFFFFF;color: #284775;">
                    <td>
                        <asp:Label ID="FilariasisEntryNumberLabelID1" runat="server" 
                            Text='<%# Eval("FilariasisEntryNumber") %>' Visible="false" />
                    </td>
                    <td>
                        <asp:Label ID="FilariasisDataLabel" runat="server" Text='<%# Eval("FilariasisData") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: #999999;">
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <asp:TextBox ID="FilariasisDataTextBox" runat="server" 
                            Text='<%# Bind("FilariasisData") %>' />
                    </td>
                    <td>
